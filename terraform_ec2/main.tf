...
resource "aws_instance" "app_server" {
  ami           = "ami-05b10e08d247fb927" # Replace with your AMI ID
  instance_type = "t2.micro"
  key_name      = "quest-key" # Replace with your key pair name
  subnet_id     = aws_subnet.public_subnet_1.id
  vpc_security_group_ids = [aws_security_group.instance_sg.id]  # Use vpc_security_group_ids instead of security_groups
